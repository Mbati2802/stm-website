                ...
                <div class="col-lg-6 d-grid gap-3">
                    ...
                    <div class="soft-card p-4 settings-card settings-card-images" data-settings-section="images">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label class="form-label">Banner Home Path/URL</label><div class="input-group"><input name="banner_home" id="banner_home" class="form-control" value="<?= e($settings['banner_home'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_home').value='';document.getElementById('delete_banner_home').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_home" id="delete_banner_home" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner Programmes Path/URL</label><div class="input-group"><input name="banner_programmes" id="banner_programmes" class="form-control" value="<?= e($settings['banner_programmes'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_programmes').value='';document.getElementById('delete_banner_programmes').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_programmes" id="delete_banner_programmes" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner About Path/URL</label><div class="input-group"><input name="banner_about" id="banner_about" class="form-control" value="<?= e($settings['banner_about'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_about').value='';document.getElementById('delete_banner_about').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_about" id="delete_banner_about" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner Contact Path/URL</label><div class="input-group"><input name="banner_contact" id="banner_contact" class="form-control" value="<?= e($settings['banner_contact'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_contact').value='';document.getElementById('delete_banner_contact').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_contact" id="delete_banner_contact" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner Events Path/URL</label><div class="input-group"><input name="banner_events" id="banner_events" class="form-control" value="<?= e($settings['banner_events'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_events').value='';document.getElementById('delete_banner_events').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_events" id="delete_banner_events" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner Library Path/URL</label><div class="input-group"><input name="banner_library" id="banner_library" class="form-control" value="<?= e($settings['banner_library'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_library').value='';document.getElementById('delete_banner_library').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_library" id="delete_banner_library" value="0"></div>
                            <div class="col-md-6"><label class="form-label">Banner Media Path/URL</label><div class="input-group"><input name="banner_media" id="banner_media" class="form-control" value="<?= e($settings['banner_media'] ?? '') ?>"><button type="button" class="btn btn-outline-danger" onclick="document.getElementById('banner_media').value='';document.getElementById('delete_banner_media').value='1'"><i class="bi bi-x"></i></button></div><input type="hidden" name="delete_banner_media" id="delete_banner_media" value="0"></div>
                        </div>
