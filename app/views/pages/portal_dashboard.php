...
?>
<section>
    <div class="portal-card p-4 mb-4" style="background:linear-gradient(120deg, var(--portal-primary), #0b7f78); color:#fff;">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                <div>
                    <h1 class="portal-title mb-2 text-white">Welcome, <?= e($studentName) ?></h1>
                    <p class="mb-1 text-white-50">Student dashboard for timetables, announcements, and updates.</p>
                    <span class="portal-badge">Admission Number: <?= e($admissionNumber) ?></span>
                </div>
