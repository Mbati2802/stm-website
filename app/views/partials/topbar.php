...
<div class="topbar py-2">
    <div class="container d-flex flex-wrap align-items-center justify-content-between gap-2 small">
        <div class="d-flex flex-wrap align-items-center gap-3 topbar-main-line">
            <span><i class="bi bi-telephone-fill me-1 topbar-icon"></i><?= e($phone) ?></span>
            <span><i class="bi bi-envelope-fill me-1 topbar-icon"></i><?= e($email) ?></span>
            <span class="topbar-location"><i class="bi bi-geo-alt-fill me-1 topbar-icon"></i><?= e($location) ?></span>
            <span class="d-inline-flex align-items-center gap-2 topbar-socials">
