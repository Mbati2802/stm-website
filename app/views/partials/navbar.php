    ...
    <div class="site-width d-flex flex-wrap align-items-center justify-content-between">
        ...
        <div class="collapse navbar-collapse flex-grow-1" id="navbarMain">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?= $path === 'programmes' ? 'active' : '' ?>" href="#" data-bs-toggle="dropdown">Programmes <i class="bi bi-chevron-down dropdown-arrow"></i></a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= e(base_url('programmes')) ?>">How To Apply</a></li>
