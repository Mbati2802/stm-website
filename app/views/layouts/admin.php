        ...
        <nav class="nav flex-column gap-2 mt-3">
            ...
            <div class="admin-nav-group">
                ...
                <div class="collapse <?= str_contains($adminPath, 'admin/list/portal_courses') || str_contains($adminPath, 'admin/list/programme_timetables') || str_contains($adminPath, 'admin/list/course_grades') || str_contains($adminPath, 'admin/list/course_assignments') || str_contains($adminPath, 'admin/list/study_materials') || str_contains($adminPath, 'admin/admission') || str_contains($adminPath, 'admin/admission-number-formats') || str_contains($adminPath, 'admin/grading') || str_contains($adminPath, 'admin/semester') ? 'show' : '' ?>" id="academicPortalGroup">
                    ...
                    <?php if (Auth::canViewEntity('course_grades')): ?><a class="nav-link <?= str_contains($adminPath, 'admin/list/course_grades') ? 'active' : '' ?>" href="<?= e(base_url('admin/list/course_grades')) ?>"><i class="bi bi-award"></i><span>Marks Entry</span></a><?php endif; ?>
                    ...
                    <?php if (Auth::canViewEntity('settings')): ?><a class="nav-link <?= str_contains($adminPath, 'admin/semester') ? 'active' : '' ?>" href="<?= e(base_url('admin/semester')) ?>"><i class="bi bi-calendar3"></i><span>Semester Management</span></a><?php endif; ?>
            ...
            <div class="admin-nav-group">
                ...
                <div class="collapse <?= str_contains($adminPath, 'admin/list/gallery') || str_contains($adminPath, 'admin/list/library_resources') || str_contains($adminPath, 'admin/messages') || str_contains($adminPath, 'admin/applications') || str_contains($adminPath, 'admin/internal-messages') || str_contains($adminPath, 'admin/support-tickets') || str_contains($adminPath, 'admin/students') || str_contains($adminPath, 'admin/accounts') || str_contains($adminPath, 'admin/media') || str_contains($adminPath, 'admin/event-registrations') || str_contains($adminPath, 'admin/list/testimonials') || str_contains($adminPath, 'admin/list/social_updates') ? 'show' : '' ?>" id="mediaGroup">
                    ...
                    <?php if (Auth::canViewEntity('students')): ?><a class="nav-link <?= str_contains($adminPath, 'admin/accounts') ? 'active' : '' ?>" href="<?= e(base_url('admin/accounts')) ?>"><i class="bi bi-wallet2"></i><span>Accounts & Billing</span></a><?php endif; ?>
