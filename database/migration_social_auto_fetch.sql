...
ALTER TABLE social_updates ADD COLUMN IF NOT EXISTS external_id VARCHAR(190) NULL;
ALTER TABLE social_updates ADD COLUMN IF NOT EXISTS external_source VARCHAR(40) NULL;
...
CREATE INDEX IF NOT EXISTS idx_social_auto ON social_updates (auto_fetched);
CREATE INDEX IF NOT EXISTS idx_social_posted_at ON social_updates (posted_at);
